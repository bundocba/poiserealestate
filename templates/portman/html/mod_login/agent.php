...
<div style='display:none'>
	<div id="agent-form" class="popup-form">
		<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="form-agent" class="form-inline" autocomplete="off">
			...
			<div class="userdata">
				<div id="form-login-username" class="control-group row">
					<div class="controls">
						<div class="col-sm-3">
							<label for="modlgn-username"><?php echo JText::_('CEA No.') ?></label>
						</div>
						<div class="col-sm-9">
							<input id="modlgn-username" type="text" name="username" class="input-small" tabindex="0" size="18" placeholder="<?php echo JText::_('CEA License No.') ?>" />
						</div>
					</div>
				</div>
