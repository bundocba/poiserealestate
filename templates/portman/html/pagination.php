...
function pagination_item_active(&$item)
{
	...
	{
		$display = '<i class="icon-previous"></i>'.JText::_('JPREV');
	}

	// Check for "Next" item
	if ($item->text == JText::_('JNEXT'))
	{
		$display = '<i class="icon-next"></i>'.JText::_('JNEXT');
	}
...
function pagination_item_inactive(&$item)
{
	...
	if ($item->text == JText::_('JPREV'))
	{
		return '<li class="disabled"><a><i class="icon-previous"></i>'.JText::_('JPREV').'</a></li>';
	}

	// Check for "Next" item
	if ($item->text == JText::_('JNEXT'))
	{
		return '<li class="disabled"><a><i class="icon-next"></i>'.JText::_('JNEXT').'</a></li>';
	}
