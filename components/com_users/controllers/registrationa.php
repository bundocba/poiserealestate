 ...
 * @since       1.6
 */
class UsersControllerRegistrationa extends UsersController
{
	/**
	...
	{	
		...
		elseif ($return === 'useractivate')
		{
			...
			$this->setRedirect(JRoute::_('index.php?option=com_users&view=registration&layout=complete&tmpl=component', false));
		}
		else
		{
			$this->setMessage(JText::_('COM_USERS_REGISTRATION_SAVE_SUCCESS'));
