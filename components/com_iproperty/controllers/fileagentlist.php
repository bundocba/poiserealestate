...
require_once JPATH_ADMINISTRATOR.'/components/com_iproperty/controllers/files.php';

class IpropertyControllerFileAgentList extends IpropertyControllerFiles
{
