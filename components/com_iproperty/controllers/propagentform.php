...
class IpropertyControllerPropAgentForm extends JControllerForm
{
	protected $view_item = 'propagentform';
      ...
      $user       = JFactory::getUser();
       ...
       for($i=0; $i<count($_FILES['propertyfile']['name']); $i++) {
            ...
            if ($tmpFilePath != ""){
              ...
              $newFilePath 	= JPATH_SITE.'/media/com_iproperty/pictures/'.$_FILES["propertyfile"]["name"][$i];
