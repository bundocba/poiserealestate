...
class IpropertyViewFileAgent extends JViewLegacy
{
	...
	$app                = JFactory::getApplication();
        ...
        if(!empty($file)){
            ...
            header('Content-Length: ' . filesize("documents/file/".$file));
            readfile("documents/file/".$file);
        }else{
        
            $filemodel = new IpropertyModelFileAgents();
            // Initialise variable
    ...
    protected function _prepareDocument()
    {
        ...
        $title = (is_object($menu) && $menu->query['view'] == 'fileagents') ? $menu->title : JText::_('SUBMIT FORMS');
        $this->iptitle = $title;
        if (empty($title)) {
