...
<div class="edit item-page<?php echo $this->pageclass_sfx; ?>">
	<h2 class="ip-property-header"><?php echo JText::_('PROPERTY DETAILS')?></h2>
        ...
        <div id="propertyedit" class="row">
            <div class="col-md-6 col-sm-6 col-xs-6">
                <!--property name-->
                 <div class="row">
                    ...
                    <div class="col-md-8">
                        <?php echo $this->form->getInput('property_name',null,$item->property_name); ?>
                    </div>
                </div>
                <!--property type-->
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <?php echo $this->form->getInput('property_type',null,$item->property_type); ?>
                    </div>
                </div>
                <!--price-->
                 <div class="row">
                    ...
                    <div class="col-md-8">
                        <?php echo $this->form->getInput('price',null,$item->price); ?>
                    </div>
                </div>
                <!--price(psf)-->
                 <div class="row">
                    ...
                    <div class="col-md-8">
                        <?php echo $this->form->getInput('price2',null,$item->price2); ?>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <?php echo $this->form->getInput('street2',null,$item->street2); ?>
                    </div>
                </div>
                <!--Condition-->
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <?php echo $this->form->getInput('condition',null,$item->condition); ?>
                    </div>
                </div>
                <!--Developers-->
                 <div class="row">
                    ...
                    <div class="col-md-8">
                        <?php echo $this->form->getInput('developer',null,$item->developer); ?>
                    </div>
                </div>
                <!--Tenure-->
                 <div class="row">
                    ...
                    <div class="col-md-8">
                        <?php echo $this->form->getInput('tenure',null,$item->tenure); ?>
                    </div>
                </div>
                <!--# of Bedroom-->
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <?php echo $this->form->getInput('beds',null,$item->beds); ?>
                    </div>
                </div>
                <!--# of Baths-->
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <?php echo $this->form->getInput('baths',null,$item->baths); ?>
                    </div>
                </div>
                <!--# Upload Image-->
                <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-6">
                ...
                <div class="row">
                   ...
                   <div class="col-md-8">
                        <?php echo $this->form->getInput('street',null,$item->street); ?>
                    </div>
                </div>
                <!--Country-->
                 <div class="row">
                    ...
                    <div class="col-md-8">
                        <?php echo $this->form->getInput('country',null,$item->country); ?>
                    </div>
                </div>
                <!--City-->
                 <div class="row">
                    ...
                    <div class="col-md-8">
                        <?php echo $this->form->getInput('city',null,$item->city); ?>
                    </div>
                </div>
                <!--Postal-->
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <?php echo $this->form->getInput('postcode',null,$item->postcode); ?>
                    </div>
                </div>
                <!--Disctrict-->
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <?php echo $this->form->getInput('region',null,$item->region); ?>
                    </div>
                </div>
                <!--Listed Date-->
                <div class="row">
                   <div class="col-md-4">
                    ...
                    <div class="col-md-8">
                        <?php echo $this->form->getInput('available',null,$item->available); ?>
                    </div>
                </div>
                <!--Status-->
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <?php echo $this->form->getInput('status',null,$item->status); ?>
                    </div>
                </div>
                <!--Description-->
               <div class="row">
                    ...
                    <div class="col-md-8">
                        <?php echo $this->form->getInput('short_description',null,$item->short_description); ?>
                    </div>
                </div>
                <!--Agent Contact-->
                <div class="row">
                   <div class="col-md-4">
                    ...
                    <div class="col-md-8">
                        <?php echo $this->form->getInput('agent_contact',null,$item->agent_contact); ?>
                    </div>
                </div>
                <div class="btn-toolbar">
                    <div class="btn-group" style="float: right;margin-right: 22%;  margin-top: 4%;">
                       
                        <button style="background: #032D5F;color: #fff;margin-right: 5px;" type="button" class="" onclick="Joomla.submitbutton('propagentform.save')">
