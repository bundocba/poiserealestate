...
<div class="ip-proplist<?php echo $this->pageclass_sfx;?>">
    ...
    {
        echo 
            '<h2 class="ip-property-header">'.JText::_('COM_IPROPERTY_PROPERTIES_HANDLED_BY' ).' '.ipropertyHTML::getCompanyName($this->company->id).' </h2><span class="pull-right small ip-pagination-results">'.$this->pagination->getResultsCounter().'</span>';
            $this->k = 0;
