...
<div class="fwuser_wrap item-page">
	...
	<div><p>To update your details, simply edit the form below.</p></div>
	...
	<div class="row" id="fwzregister">
		...
		<div style="width: 80%;float: left;">
			<div style="width: 30%;float: left;">
				...
				<input type="checkbox" name="chk_receivetype[]" size="14" class="" value="1" id="newletter">
			</div>
			<div style="width: 30%;float: left;">
				<label class="label"><?php echo JText::_('SMS'); ?><span>*</span></label>
				<input type="checkbox" name="chk_receivetype[]" size="14" class="" value="2" id="sms">
			</div>
			<div style="width: 30%;float: left;">
				<label class="label"><?php echo JText::_('Telephone Call'); ?><span>*</span></label>
				<input type="checkbox" name="chk_receivetype[]" size="14" class="" value="3" id="telephone">
			</div>
		</div>
	</div>
	<div class="row" id="fwzregister">
		...
		<div class="left80">
			...
			<div class="row">
				<div class="left30 mf10">
					...
					<div class="left10">
						<input type="checkbox" name="chk_propertyupdate[]" size="14" class="" value="1" id="resale">
					</div>
				</div>
			</div>
			<div class="row">
				<div class="left30 mf10">
					...
					<div class="left10">
						<input type="checkbox" name="chk_propertyupdate[]" size="14" class="" value="2" id="executive">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="left80">
			...
			<div class="row">
				<div class="left40 mf10">
					...
					<div class="left10">
						<input type="checkbox" name="chk_newsupdate[]" size="14" class="" value="1" id="lastetproperty">
					</div>
				</div>
			</div>
			<div class="row">
				<div class="left40 mf10">
					...
					<div class="left10">
						<input type="checkbox" name="chk_newsupdate[]" size="14" class="" value="2" id="invesment">
					</div>
				</div>
			</div>
			<div class="row">
				<div class="left40 mf10">
					...
					<div class="left10">
						<input type="checkbox" name="chk_newsupdate[]" size="14" class="" value="3" id="newproject">
					</div>
				</div>
			</div>
		</div>
