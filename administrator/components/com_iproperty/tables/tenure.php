...
class IpropertyTableTenure extends JTable
{
	public function __construct(&$_db)
	{
		parent::__construct('#__iproperty_tenure', 'id', $_db);
	}
    ...
    public function check()
	{
        ...
        if(!$ipauth->canFeatureTenure($this->id)){
            unset($this->featured);
        }
        if(!$ipauth->canPublishTenure($this->id)){
            unset($this->state);
        }
	...
	public function store($updateNulls = false)
	{
		...
		$table = JTable::getInstance('Tenure', 'IpropertyTable');
