...
class IpropertyTableFileAgent extends JTable
{
	public function __construct(&$_db)
	{            
		parent::__construct('#__iproperty_fileagent', 'id', $_db);
	}
	...
	public function store($updateNulls = false)
	{
		...
		{
			// Get the old row
			$oldrow = JTable::getInstance('FileAgent', 'IpropertyTable');
	...
	public function publish($pks = null, $state = 1, $userID = 0)
	{
		...
		$table = JTable::getInstance('FileAgent','IpropertyTable');
        ...
        foreach($pks as $pk){
            ...
            {			
                ...
                if (!$table->remote){
                    ...
                    $query->select("id");
                    $query->from("#__iproperty_fileagent");
