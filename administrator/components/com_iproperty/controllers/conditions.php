...
class IpropertyControllerConditions extends JControllerAdmin
{
    ...
    public function getModel($name = 'Condition', $prefix = 'IpropertyModel', $config = array('ignore_request' => true))
	{
	...
	public function publish()
	{
        ...
        if (empty($cid)) {
            ...
            // Change the items.
            if ($count = $model->publishCondition($cid, $value)) {
    ...
    public function feature()
	{
        ...
        if (empty($cid)) {
            ...
            // Change the items.
            if ($count = $model->featureCondition($cid, $value)) {
    ...
    public function remove()
	{
        ...
        if (empty($cid)) {
			...
			// Remove the items.
			if ($count = $model->deleteCondition($cid)) {
	...
	{
		return 'index.php?option=com_iproperty&view=conditions';
	}
}
?>
