...
class IpropertyControllerPropertyAgents extends JControllerAdmin
{
	...
	public function getModel($name = 'Propertyagent', $prefix = 'IpropertyModel', $config = array('ignore_request' => true))
	{
	...
	{
		return 'index.php?option=com_iproperty&view=propertyagents';
	}
}
?>