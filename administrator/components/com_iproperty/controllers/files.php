...
class IpropertyControllerFiles extends JControllerAdmin
{
    ...
    public function getModel($name = 'File', $prefix = 'IpropertyModel', $config = array('ignore_request' => true))
	{
	...
	{
		return 'index.php?option=com_iproperty&view=files';
	}
}
?>
