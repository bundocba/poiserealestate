...
class IpropertyControllerFileAgents extends JControllerAdmin
{
    ...
    public function getModel($name = 'FileAgent', $prefix = 'IpropertyModel', $config = array('ignore_request' => true))
	{
	...
	public function publish()
	{
        ...
        if (empty($cid)) {
            ...
            // Change the items.
            if ($count = $model->publishFile($cid, $value)) {
    ...
    public function feature()
	{
        ...
        if (empty($cid)) {
            ...
            // Change the items.
            if ($count = $model->featureFile($cid, $value)) {
	...
	{
		return 'index.php?option=com_iproperty&view=fileagents';
	}
}
?>
