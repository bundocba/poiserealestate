...
class IpropertyControllerPropertyTypes extends JControllerAdmin
{
    ...
    public function getModel($name = 'PropertyType', $prefix = 'IpropertyModel', $config = array('ignore_request' => true))
	{
	...
	public function publish()
	{
        ...
        if (empty($cid)) {
            ...
            // Change the items.
            if ($count = $model->publishPropertyType($cid, $value)) {
    ...
    public function feature()
	{
        ...
        if (empty($cid)) {
            ...
            // Change the items.
            if ($count = $model->featurePropertyType($cid, $value)) {
    ...
    public function remove()
	{
        ...
        if (empty($cid)) {
			...
			// Remove the items.
			if ($count = $model->deletePropertyType($cid)) {
	...
	{
		return 'index.php?option=com_iproperty&view=propertytypes';
	}
}
?>
