...
class IpropertyControllerTrainings extends JControllerAdmin
{
    ...
    public function getModel($name = 'Training', $prefix = 'IpropertyModel', $config = array('ignore_request' => true))
	{
	...
	public function publish()
	{
        ...
        if (empty($cid)) {
            ...
            // Change the items.
            if ($count = $model->publishTraining($cid, $value)) {
    ...
    public function feature()
	{
        ...
        if (empty($cid)) {
            ...
            // Change the items.
            if ($count = $model->featureTraining($cid, $value)) {
    ...
    public function remove()
	{
        ...
        if (empty($cid)) {
			...
			// Remove the items.
			if ($count = $model->deleteTraining($cid)) {
	...
	{
		return 'index.php?option=com_iproperty&view=trainings';
	}
}
?>
