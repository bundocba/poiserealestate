...
<script language="javascript" type="text/javascript">
    Joomla.submitbutton = function(task)
	{
        ...
        if (task == 'condition.cancel' || document.formvalidator.isValid(document.id('adminForm'))) {
                ...
                <div class="tab-pane active" id="codetails">
                    <div class="row-fluid">
                        <div class="span6 form-vertical">
                            <h4><?php echo JText::_('COM_IPROPERTY_TRAINING'); ?></h4>
                            <hr />
                            ...
                            <div class="control-group">
                                <div class="control-label">
                                    <?php echo $this->form->getLabel('pax'); ?>
                                </div>
                                <div class="controls">
                                    <?php echo $this->form->getInput('pax'); ?>
                                </div>
                            </div>
