...
<script language="javascript" type="text/javascript">
    Joomla.submitbutton = function(task)
	{
		...
		if (task == 'propertytype.save2copy'){
        ...
        if (task == 'propertytype.cancel' || document.formvalidator.isValid(document.id('adminForm'))) {
                ...
                <div class="tab-pane active" id="codetails">
                    <div class="row-fluid">
                        <div class="span6 form-vertical">
                            <h4><?php echo JText::_('COM_IPROPERTY_PROPERTYTYPE'); ?></h4>
                            <hr />
       ...
       <div class="span3 form-vertical">
            <?php if ($this->ipauth->getAdmin()): ?>
                ...
                <div class="alert alert-success">
                    <h4><?php echo JText::_('COM_IPROPERTY_PROPERTYTYPE_PARAMETERS');?></h4>   
                    <hr />
                    <div class="control-group">
