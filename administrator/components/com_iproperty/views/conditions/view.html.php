...
class IpropertyViewConditions extends JViewLegacy
{
    protected $items;
    ...
    public function display($tpl = null)
	{
        ...
        // Load the submenu.
		IpropertyHelper::addSubmenu(JFactory::getApplication()->input->getCmd('view', 'conditions'));
	...
	{
		JToolBarHelper::title(JText::_('COM_IPROPERTY_CONDITIONS'), 'iproperty.png');
        ...
        if ($this->ipauth->getAdmin()){   
            ...
            IpToolbar::featureList('conditions.feature', JText::_('COM_IPROPERTY_FEATURE'));
            IpToolbar::unfeatureList('conditions.unfeature', JText::_('COM_IPROPERTY_UNFEATURE'));
            JToolBarHelper::divider();
            JToolBarHelper::publishList('conditions.publish', 'JTOOLBAR_PUBLISH');
            JToolBarHelper::unpublishList('conditions.unpublish', 'JTOOLBAR_UNPUBLISH');
            JToolBarHelper::divider();
            JToolBarHelper::deleteList(JText::_('COM_IPROPERTY_CONFIRM_DELETE'), 'conditions.delete', 'JTOOLBAR_DELETE');
		}
        
        // Add search filters
		JHtmlSidebar::setAction('index.php?option=com_iproperty&view=conditions');
