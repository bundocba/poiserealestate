...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_iproperty&task=files.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_iproperty&view=fileagents'); ?>" method="post" name="adminForm" id="adminForm">
                        ...
                        <tr class="row<?php echo $i % 2; ?>">
                            ...
                            <td class="nowrap has-context">
                                <div class="pull-left">
                                    ...
                                    <?php endif; ?>
                                    <?php if ($canEdit) : ?>
                                        <a href="<?php echo JRoute::_('index.php?option=com_iproperty&task=fileagent.edit&id='.(int) $item->id); ?>">
                                ...
                                <div class="pull-right">
                                    <?php
                                        ...
                                        if($canPublish):
                                            if ($item->state) :
                                                JHtml::_('dropdown.unpublish', 'cb' . $i, 'files.');
                                            else :
                                                JHtml::_('dropdown.publish', 'cb' . $i, 'files.');
                                            endif;
                                            JHtml::_('dropdown.divider');
                                        endif;                                    
                                        ...
                                        if ($item->checked_out && $canCheckin) :
                                            JHtml::_('dropdown.checkin', 'cb' . $i, 'files.');
                                        endif;
                            ...
                            <td class="small hidden-phone center">
                                <div class="btn-group">
                                    <?php echo JHtml::_('jgrid.published', $item->state, $i, 'files.', $canPublish, 'cb'); ?>
                                    <?php echo JHtml::_('ipadministrator.featured', $item->featured, $i, $canFeature, 'files'); ?>
                                </div>
                            </td>
