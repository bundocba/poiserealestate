...
class IpropertyViewPropertyAgent extends JViewLegacy 

{
	...
	{		 
        ...
        JToolBarHelper::apply('propertyagent.apply', 'JTOOLBAR_APPLY');

        JToolBarHelper::save('propertyagent.save', 'JTOOLBAR_SAVE');
        ...
        if ($this->ipauth->getAdmin()){
            ...
            JToolBarHelper::custom('propertyagent.save2new', 'save-new.png', 'save-new_f2.png', 'JTOOLBAR_SAVE_AND_NEW', false);
            ...
            if (!$isNew) {
                ...
                JToolBarHelper::custom('propertyagent.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY', false);
		...
		if (empty($this->item->id))  {
			...
			JToolBarHelper::cancel('propertyagent.cancel','JTOOLBAR_CANCEL');

		}

		else {

			JToolBarHelper::cancel('propertyagent.cancel', 'JTOOLBAR_CLOSE');
