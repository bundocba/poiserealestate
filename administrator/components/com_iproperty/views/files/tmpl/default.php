...
<form action="<?php echo JRoute::_('index.php?option=com_iproperty&view=files'); ?>" method="post" name="adminForm" id="adminForm">
                        ...
                        <tr class="row<?php echo $i % 2; ?>">
                            ...
                            <td class="nowrap has-context">
                                <div class="pull-left">
                                    ...
                                    <?php endif; ?>
                                    <?php if ($canEdit) : ?>
                                        <a href="<?php echo JRoute::_('index.php?option=com_iproperty&task=file.edit&id='.(int) $item->id); ?>">
