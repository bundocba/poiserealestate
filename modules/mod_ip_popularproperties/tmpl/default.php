...
<div class="row-fluid<?php echo $moduleclass_sfx; ?>">
    ...
    foreach($items as $item)
    {
        ...
        ?>
        <div class="ip-popularproperties-holder span<?php echo $rowspan; ?>">
            <?php if($iplayout == 'rows') echo '<div class="span3">'; ?>
                <div class="ip-mod-thumb ip-popularproperties-thumb-holder">
                    <?php echo ipropertyHTML::getThumbnail($item->id, $item->proplink, $item->street_address, '', 'class="ip-popularproperties-img thumbnail"', '', $usethumb); ?>
            ...
            ?>
            <div class="ip-mod-desc ip-popularproperties-desc-holder span9">
            ...
            <?php if($params->get('show_readmore', 1)): ?>
                <div class="ip-mod-readmore ip-popularproperties-readmore">
                    <a href="<?php echo $item->proplink; ;?>" class="btn btn-primary readon"><?php echo JText::_('MOD_IP_POPULAR_READ_MORE'); ?></a>
                </div>
            <?php endif; ?>
        </div>
        <?php
