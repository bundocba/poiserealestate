...
<div class="row-fluid<?php echo $moduleclass_sfx; ?>">
    ...
    foreach($items as $item)
    {
        ...
        ?>
        <div class="ip-recentproperties-holder span<?php echo $rowspan; ?>">
            ...
            <?php if($params->get('show_readmore', 1)): ?>
                <div class="ip-mod-readmore ip-recentproperties-readmore">
                    <a href="<?php echo $item->proplink; ;?>" class="btn btn-primary readon"><?php echo JText::_('MOD_IP_RECENT_READ_MORE'); ?></a>
                </div>
            <?php endif; ?>
        </div>
        <?php
